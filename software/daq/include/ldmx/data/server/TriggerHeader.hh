...
#ifndef __LDMX_DATA_SERVER_TRIGGERHEADER_HH__
#define __LDMX_DATA_SERVER_TRIGGERHEADER_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/server/TriggerHeader.hh
  \brief  Defines filling the trigger header structure.
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief  Fill the trigger header
                                                                          */
/* ---------------------------------------------------------------------- */
class TriggerHeader : public ldmx::data::common::TriggerHeader
{
public:
   TriggerHeader () = delete;

   TriggerHeader (uint8_t         blockSize0,
   ...
   TriggerHeader (uint8_t          blockSize,
                  uint16_t       blockNumber,
                  bool      timestampPresent);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief Constructor for the Trigger header

  \note
   There is one trigger header for each batch of trigger events.  There
   is no trigger trailer.
                                                                          */
/* ---------------------------------------------------------------------- */
inline TriggerHeader::TriggerHeader (uint8_t         blockSize0,
                                     uint16_t       blockNumber,
                                     uint8_t        boardTypeId,
                                     uint8_t          tiBoardId,
                                     uint8_t      blockHeaderId,
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief Constructor for the Trigger header with fixed fields filled with
  ...
  \note
   ...
   is no trigger trailer.
                                                                          ...
                                                                          */
/* ---------------------------------------------------------------------- */
inline TriggerHeader::TriggerHeader (uint8_t          blockSize,
                                     uint16_t       blockNumber,
                                     bool      timestampPresent) :
                                        
   TriggerHeader (blockSize,
                  blockNumber,
                  ldmx::data::common::TriggerHeader::BoardTypeId,
                  ldmx::data::common::TriggerHeader::TiBoardId,
                  ldmx::data::common::TriggerHeader::BlockHeaderId,
                  blockSize,
                  timestampPresent,
                  ldmx::data::common::TriggerHeader::Mbf0,
                  ldmx::data::common::TriggerHeader::Mbf1)
{
   return;
}
/* ---------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief  Convenience method to customize the general template method
          to add a field to be specific for the trigger header word.
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] blockSize The block size 
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addBlockSize0  (uint8_t blockSize)
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] blockSize  The block size (actually the trigger event count)
                        to add
                                                                          */
/* ---------------------------------------------------------------------- */
inline void  TriggerHeader::setBlockSize (uint8_t blockSize)
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] blockNumber The block nubmer
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addBlockNumber (uint16_t blockNumber)
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] blockTypeId The board type identifier
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addBoardTypeId (uint8_t boardTypeId)
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] tiBoardTypeId The TI board identifier
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addTiBoardId (uint8_t tiBoardId)
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] tiBoardTypeId The TI board identifier
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addBlockHeaderId (uint8_t blockHeaderId)
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] blockSize The block size
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addBlockSize1 (uint8_t blockSize)
{
   uint64_t field = add<uint8_t>(        blockSize,
                                 Mask  ::BlockSize1,
                                 Offset::BlockSize1);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return    The correctly masked and justified field
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addMbf0 ()
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \note
   ...
   verifier can be tested.
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addMbf0 (uint8_t mbf0)
{
   uint64_t field = add<uint8_t>(        mbf0,
                                 Mask  ::Mbf0,
                                 Offset::Mbf0);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] present  Flag indicating the presence/absence of the timestamp
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addTimestamp (bool present)
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return    The correctly masked and justified field
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addMbf1 ()
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \note
   ...
   verifier can be tested.
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint64_t TriggerHeader::addMbf1 (uint16_t mbf1)
{
   uint64_t field = add<uint16_t>(        mbf1,
                                  Mask  ::Mbf1,
                                 Offset::Mbf1);
