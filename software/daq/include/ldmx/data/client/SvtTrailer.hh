...
#ifndef __LDMX_DATA_CLIENT_SVTRAILER_HH__
#define __LDMX_DATA_CLIENT_SVTRAILER_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/client/SvtTrailer.hh
  \brief  Defines accessing the SVT trailer structure.
  \author JJRussell - russell@slac.stanford.edu

  \par
   This various member fields of the SvtTrailer.
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief  Class to access the members of the SVT trailer
                                                                          */
/* ---------------------------------------------------------------------- */
...
public:
   static void print (SvtTrailer const *trailer);
   void print () const;
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The number of multi-sample records
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint16_t SvtTrailer::getMultiSampleCount () const
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \par
   ...
   overflow.
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint16_t SvtTrailer::getSkipCount () const
{
   uint8_t value = get<uint16_t>(            m_w32,
                                 Mask  ::SkipCount, 
                                 Offset::SkipCount);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The 3-bit undefined field
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint8_t SvtTrailer::getUndefined0 () const
{
   uint8_t value = get<uint16_t>(             m_w32,
                                 Mask  ::Undefined0, 
                                 Offset::Undefined0);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The APV sync error flag
                                                                          */
/* ---------------------------------------------------------------------- */
inline bool SvtTrailer::getApvSyncError () const
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The APV FIFO backup error flag
                                                                          */
/* ---------------------------------------------------------------------- */
inline bool SvtTrailer::getApvFifoBackupError () const
{
   uint8_t value = get<bool>(                     m_w32,
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The 4-bit undefined field
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint8_t SvtTrailer::getUndefined1 () const
{
   uint8_t value = get<uint16_t>(             m_w32,
                                 Mask  ::Undefined1, 
                                 Offset::Undefined1);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief Prints the SVT event trailer to the console
                                                                          */
/* ---------------------------------------------------------------------- */
inline void SvtTrailer::print () const
{
   print (this);
   return;
}
