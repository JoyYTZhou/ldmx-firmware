...
#ifndef __LDMX_DATA_COMMON_SVTMULTISAMPLE_HH__
#define __LDMX_DATA_COMMON_SVTMULTISAMPLE_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/common/Svt.hh
  \brief  Defines the Svt event multi- sample data structure.
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief Defines the bit fields and the optional 32-bit words that
         comprise the SVT Multi Sample Data
                                                                          */
/* ---------------------------------------------------------------------- */
struct SvtMultiSample
{
   /* ------------------------------------------------------------------- *\
    |                                                                     |
    |  Word 0 - 2:                                                        |
