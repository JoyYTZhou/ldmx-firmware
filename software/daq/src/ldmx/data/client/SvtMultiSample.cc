...
/* ---------------------------------------------------------------------- *//*!
  ...
  \file   ldmx/data/server/SvtMultiSample.cc
  \brief  Accesses the SVT multi-sample data structure.
...
namespace client     {
/* ---------------------------------------------------------------------- */
void SvtMultiSample::printTitle ()
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in]  ims  The instance number of the multi-sample data record
                                                                          */
/* ---------------------------------------------------------------------- */
void SvtMultiSample::print (SvtMultiSample const *ms,
                                   int                  ims)
{
