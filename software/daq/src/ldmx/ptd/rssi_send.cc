...
int main (int argc, char **argv) {
   ...
   rogue::protocols::udp::ServerPtr udp  = rogue::protocols::udp::Server::create(8192,true);
   ...
   std::shared_ptr<TestSend> send = std::make_shared<TestSend>();
   /// --- streamConnect(send,pack->application(0))
   rogueStreamConnect(send,pack->application(0))
