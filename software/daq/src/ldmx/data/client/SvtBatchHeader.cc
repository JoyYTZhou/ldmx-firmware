...
/* ---------------------------------------------------------------------- *//*!
  ...
  \file   ldmx/data/client/SvtBatchHeader.cc
  \brief  Accesses the SVT batch header structure.
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \param[in] hdr  The SVT batch header
                                                                          */
/* ---------------------------------------------------------------------- */
void SvtBatchHeader::print (SvtBatchHeader const *hdr)
{
