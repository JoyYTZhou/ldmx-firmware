...
/* ---------------------------------------------------------------------- *//*!
  ...
  \file   ldmx/data/client/SvtBatchTail.cc
  \brief  Accesses the SVT batch tail word structure.
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief Prints the SVT batch tail to the console
                                                                          */
/* ---------------------------------------------------------------------- */
namespace ldmx       {
namespace data       {
namespace client     {
/* ---------------------------------------------------------------------- */
void SvtBatchTail::print (SvtBatchTail const *tail)
{
