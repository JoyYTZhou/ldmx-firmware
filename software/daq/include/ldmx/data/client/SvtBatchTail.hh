...
#ifndef __LDMX_DATA_CLIENT_SVTBATCHTAIL_HH__
#define __LDMX_DATA_CLIENT_SVTBATCHTAIL_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/client/SvtBatchTail.hh
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief  Class to access the members of the SVT batch tail
                                                                          */
/* ---------------------------------------------------------------------- */
...
public:
   static void print (SvtBatchTail const *tail);
   void        print () const;
                      ...
                      ldmx::data::common::SvtBatchTail::Offset offset)
{
   ...
   ldmx::utl::bf::extract<uint32_t,
                          ...
                          ldmx::data::common::SvtBatchTail::Offset>
                         (w32, mask, offset);
   return value;
}
/* ---------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \note
   This value includes the rounding up to the AXI stream bit width
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint32_t SvtBatchTail::getNValid () const
{
   return  m_nvalid;
}
/* ---------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The number of valid bytes in the the data payload
                                                                          ...
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint32_t SvtBatchTail::getNBytes () const
{
   /// printf ("SvtBatchTail: m_nvalid = %8" PRIx32 "\n", m_nvalid);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The 8-bit value of the tDest field
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint8_t SvtBatchTail::getTDest () const
{
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The 8-bit value of the tUserFirst field
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint8_t SvtBatchTail::getTUserFirst () const
{
   uint8_t value = get<uint8_t>(          m_status, 
                                Mask  ::TUserFirst, 
                                Offset::TUserFirst);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The error flag
                                                                          */
/* ---------------------------------------------------------------------- */
inline bool SvtBatchTail::getErrorFlag () const
{
   uint8_t value = get<uint8_t>(         m_status, 
                                Mask  ::TUserLast, 
                                Offset::TUserLast) & 1;
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The 7-bit value of the tUserLast field
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint8_t SvtBatchTail::getTUserLast () const
{
   uint8_t value = get<uint8_t>(         m_status, 
                                Mask  ::TUserLast, 
                                Offset::TUserLast);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \return  The AXI bit stream width, this is should be one of the 
           enum ldmx::common::AxiBitStreamWidth values
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint8_t SvtBatchTail::getWidth () const
{
   uint8_t value = get<uint8_t>(      m_status, 
                                Mask  ::Width, 
                                Offset::Width);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \note
   ...
   to be 0 or just for completeness
                                                                          */
/* ---------------------------------------------------------------------- */
inline uint8_t SvtBatchTail::getRsvd () const
{
   uint8_t value = get<uint8_t>(    m_status, 
                                Mask  ::Rsvd, 
                                Offset::Rsvd);
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief Print the SVT batch tail
                                                                          */
/* ---------------------------------------------------------------------- */
inline void SvtBatchTail::print () const
{
   print (this);
   return;
}
