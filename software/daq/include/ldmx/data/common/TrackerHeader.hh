...
#ifndef __LDMX_DATA_COMMON_TRACKERHEADER_HH__
#define __LDMX_DATA_COMMON_TRACKERHEADER_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/common/TrackerHeader.hh
  \brief  Defines the layout of the tracker header structure.
...
struct TrackerHeader
{
   ...
   /* ------------------------------------------------------------------- *\
    |                                                                     |
    | Layout of the tracker header bit fields                             |
    | ---------------------------------------                             |
    |                                                                     |
