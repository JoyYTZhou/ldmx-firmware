...
#ifndef __LDMX_DATA_COMMON_SVTTRAILER_HH__
#define __LDMX_DATA_COMMON_SVTTRAILER_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/common/SvtTrailer.hh
  \brief  Defines the Svt event trailer structure.
