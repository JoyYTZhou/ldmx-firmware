...
#ifndef __LDMX_DATA_COMMON_SVTBATCHHEADER_HH__
#define __LDMX_DATA_COMMON_SVTBATCHHEADER_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/common/SvtBatchHeader.hh
  \brief  Defines the Svt batch header structure.
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief  Trigger/Batch super frame header
                                                                          */
/* ---------------------------------------------------------------------- */
struct SvtBatchHeader
{
   /* ------------------------------------------------------------------- *\
    |                                                                     |
    | Layout of the SVT Batch header                                      |
    | ------------------------------                                      |
    |                                                                     |
   ...
   /* ------------------------------------------------------------------- *//*!
     ...
     \par
      ...
      For the current SVT firmware this is 64-bits
                                                                          */
   /* ------------------------------------------------------------------- */
   enum Width 
   {
