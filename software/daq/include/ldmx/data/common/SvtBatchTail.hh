...
#ifndef __LDMX_DATA_COMMON_SVTBATCHTAIL_HH__
#define __LDMX_DATA_COMMON_SVTBATCHTAIL_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/common/SvtBatchTail.hh
  \brief  Defines the Svt batch tail structure.
  \author JJRussell - russell@slac.stanford.edu

  \par
   The BatchTail acts as a separator between the batched SvtEvents.
   It is \e not a trailer, in the traditional meaning of trailer, that
   only goes at the end of the batched SvtEvents.
