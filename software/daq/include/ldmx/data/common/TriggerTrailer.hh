...
#ifndef __LDMX_DATA_COMMON_TRIGGERTRAILER_HH__
#define __LDMX_DATA_COMMON_TRIGGERTRAILER_HH__

/* ---------------------------------------------------------------------- *//*!

  \file   ldmx/data/common/TriggerTrailer.hh
  \brief  Defines the layout of the trigger trailer structure.
