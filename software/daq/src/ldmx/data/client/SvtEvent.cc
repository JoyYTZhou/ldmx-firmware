...
/* ---------------------------------------------------------------------- *//*!
  ...
  \file   ldmx/data/server/SvtEvent.cc
  \brief  Access the memory buffer containing 1 SVT event.
...
/* ---------------------------------------------------------------------- *//*!
  ...
  \brief Prints the SVT event to the console
                                                                          */
/* ---------------------------------------------------------------------- */
void SvtEvent::print (SvtEvent const *evt)
{
   ...
   ldmx::data::client::SvtMultiSample::printTitle ();
